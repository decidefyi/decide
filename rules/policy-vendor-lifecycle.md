...
- crunchyroll: expired; refund:degraded(latest_check_fetch_failed), cancel:degraded(latest_check_fetch_failed), return:degraded(latest_check_fetch_failed), trial:expired(source_freshness_expired)
- dashlane: monitored
- deezer: monitored
...
## Candidate burn-in
- ClickUp: candidate
  - cancel: ready_for_review; observations=120; success=100.00%
  - refund: ready_for_review; observations=120; success=100.00%
  - return: candidate; observations=0; success=n/a; blocker=manual_policy_applicability_review_required
  - trial: ready_for_review; observations=120; success=100.00%
- Miro: candidate
  - cancel: ready_for_review; observations=120; success=100.00%
  - refund: ready_for_review; observations=120; success=100.00%
  - return: candidate; observations=0; success=n/a; blocker=manual_policy_applicability_review_required
