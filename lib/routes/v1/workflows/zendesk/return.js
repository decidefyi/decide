import returnEligibilityHandler from "../../policies/return-eligibility.js";
...
export default createZendeskWorkflowHandler({
  ...
  buildPolicyBody: ({ vendor, daysSincePurchase, region, plan, input }) => ({
    vendor,
    days_since_purchase: daysSincePurchase,
    region,
    plan,
    ...(typeof input.qualifying_conditions_met === "boolean"
      ? { qualifying_conditions_met: input.qualifying_conditions_met }
      : {}),
  }),
  buildAction,
});
