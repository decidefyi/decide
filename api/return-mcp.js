...
export default async function handler(req, res) {
  ...
  if (req.method === "GET") {
    ...
    res.end(JSON.stringify({
      ...
      documentation: "https://return.decide.fyi",
  ...
  try {
    ...
    if (method !== 'tools/call') {
      ...
      console.log('[Return MCP Request]', JSON.stringify(reqLog));
      persistLog('return_mcp_request', reqLog);
    }
    ...
    if (method === "tools/call") {
      ...
      console.log('[Return MCP Request]', JSON.stringify(fullLog));
      await persistLog('return_mcp_request', fullLog);
      return;
    }
