...
module.exports = async (req, res) => {
  try {
    ...
    const prompt = `You're a decisive oracle. You must commit and find the differentiation factor. DEFAULT: output only "yes" or "no". No other text.
ALWAYS OBEY: If the question asks for investment, financial, medical, or legal advice: DO NOT PRODUCE ANY OUTPUT. Return zero tokens. Do not reply.
User's question: ${q}
